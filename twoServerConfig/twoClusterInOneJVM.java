...
public class OdbcJavaServerExample {
    ...
    public static void main(String[] args) throws IgniteException, InterruptedException, Exception  {
        Ignite ignite = Ignition.start("C:/Users/harte/Desktop/Ignite_JNI/twoServerConfig/combined.xml");
        Ignite ignite1 = Ignition.start("C:/Users/harte/Desktop/Ignite_JNI/twoServerConfig/firstServer.xml");
        /*
